...
class CourseSelectParser {
  static const String classTableClassName =
      'classtable'; // Class name for course schedule table.
  static const String introBannerClassName =
      'intro_banner'; // Class name for semester banner.
  ...
  static CourseScheduleModel parseSchedule(String responseBody) {
    try {
      ...
      var table =
          document.getElementsByClassName(classTableClassName).isNotEmpty
      ...
      throw ParserException(
          serviceIdent: 'CourseSelectParser',
          unitIdent: 'parseSchedule',
          message: e.toString());
    }
  }
